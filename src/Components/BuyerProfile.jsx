...
import { Camera, Edit3, Lock, LogOut, Check, X, User, Phone, MapPin, Globe } from "lucide-react";
  ...
  return (
    <>
      <style>{`
        ...
        body { margin: 0; font-family: 'Outfit', 'Segoe UI', Arial, sans-serif; background: #f8fafc; }
        ...
        .upload-badge {
          ...
          background: #fff; color: #2e8b57; padding: 8px;
        ...
        .info-icon { background: #fff; padding: 10px; border-radius: 12px; color: #2e8b57; box-shadow: 0 2px 5px rgba(0,0,0,0.03); }
        .info-text { flex: 1; }
        ...
        .form-input:focus { border-color: #2e8b57; background: #fff; box-shadow: 0 0 0 4px rgba(46, 139, 87, 0.1); }
        ...
        .nav-item.active { color: #2e8b57; font-weight: 700; }
      ...
      <div className="profile-container">
        {loading && <div style={{position: "absolute", top:0, left:0, right:0, height: "4px", background: "#2e8b57", zIndex: 100}} />}
        ...
        <div className="profile-header">
          ...
          <p style={{margin: "4px 0 0", opacity: 0.8, fontSize: "14px"}}>Buyer Account</p>
        </div>
            ...
            <div style={{animation: "fadeIn 0.4s ease-out"}}>
              <div className="section-title">
                ...
                <button 
                  ...
                  style={{background: "none", border: "none", color: "#2e8b57", fontWeight: "bold", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px"}}
                >
                  <Edit3 size={16} /> Edit
                </button>
              </div>
        ...
        <div className="bottom-nav">
          <div className="nav-item" onClick={() => navigate("/buyer-dashboard")}><span>🏠</span><span>Home</span></div>
          <div className="nav-item" onClick={() => navigate("/buyer-explore")}><span>🔍</span><span>Explore</span></div>
          <div className="nav-item" onClick={() => navigate("/buyer-cart")}><span>🛒</span><span>Cart</span></div>
          <div className="nav-item" onClick={() => navigate("/buyer-orders")}><span>📦</span><span>Orders</span></div>
